...
filenameC1='FOV4_Gain300_20ms_FarRed_1_crop_TS_filtered_corr';          % -->  far red channel
filenameC1_2=[filenameC1 '.txt'];
filenameC2='FOV4_Gain300_20ms_Red_1_crop_TS_filtered2';              % -->  red channel
...
%% Select ROI and scatter 

upperx=9600; % max(all(:,1));
lowerx=9000;
